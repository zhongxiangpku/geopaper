...
public class NewsCrawler2 extends BreadthCrawler {
    ...
    public NewsCrawler2(String crawlPath, boolean autoParse) {
        ...
        /*种子页面*/
        this.addSeed("http://bj.meituan.com/shop/4587194?acm=UwunyailsW3843807269386670304.4587194.44&mtt=1.index%2Fdefault%2Fpoi.pz.328.ir62cv1y&cks=12883#bdw");
...
//            System.out.println("content:\n" + content);
    ...
    public static void main(String[] args) throws Exception {
        NewsCrawler2 crawler = new NewsCrawler2("meituan", true);
        /*线程数*/
