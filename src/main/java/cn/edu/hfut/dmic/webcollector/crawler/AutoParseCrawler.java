...
public abstract class AutoParseCrawler extends Crawler implements Executor, Visitor, Requester {
    ...
    public AutoParseCrawler(boolean autoParse) {
    	proxys=new Proxys();
    	//proxys.add("39.1.43.190", 8080);

//    	proxys.add("180.249.232.109", 8080);
//    	proxys.add("156.199.23.241", 8080);
//    	proxys.add("114.252.17.207", 8118);
//    	proxys.add("121.31.100.235", 8889);
    	
    	//proxys.add("183.19.43.189",3128);
    	//36.76.17.31	8080
    	//proxys.addEmpty();
